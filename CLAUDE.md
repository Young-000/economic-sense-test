...
|------|------|------|
| 게임 완료 | +15 coin | 무제한 |
| 고티어 (S/SS) | +30 coin | 무제한 |
| 보상형 광고 | +100 coin | 일 5회 |
| 결과 공유 | +20 coin | 일 1회 |
| 일일 출석 | +50 coin | 일 1회 |
| 스트릭 3/7/14/30일 | +10/20/30/50 coin | 일 1회 |

**일일 시나리오 (적극 사용자, 3퀴즈 + 5광고):**
- 출석 50 + 스트릭(7일) 20 + 퀴즈 45 + 고티어 30 + 광고 500 + 공유 20 = 665 coin
- 미션 보상 포함 시 ~1000 coin (초기 며칠)

- 교환: promotion Edge Function 경유

### 광고 (v2 API)
- 보상형: 결과 페이지 (+100 coin), 60초 쿨다운, 일 5회
- 전면: 게임 완료 후, 일 10회
- 배너: 결과 페이지 하단
- 수익: 전면 ~9원 + 보상형 ~20원 + 배너 ~1원 = ~30원/일

### 미션 (3트랙 x 4스테이지, 투자자 등급 테마)
- 투자자: 씨앗(1) -> 개미(5) -> 큰손(20) -> 슈퍼개미(50) / 보상 50/60/80/100
- 연속 도전: 초보(3일) -> 습관(7일) -> 프로(14일) -> 전설(30일) / 보상 50/60/80/100
- 수익왕: 인턴(B) -> 매니저(A) -> 임원(S) -> CEO(SS) / 보상 50/60/80/100
- 총 미션 보상: 870 coin (3트랙 x 290 coin)
